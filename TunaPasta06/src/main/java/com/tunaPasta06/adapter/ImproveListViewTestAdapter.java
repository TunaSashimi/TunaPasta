...
import com.tunaPasta06.tool.ImageLoader;
public class ImproveListViewTestAdapter extends BaseAdapter {
	...
	public ImproveListViewTestAdapter(int count, Context context) {
		this.mCount = count;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.improvelistviewtestitem, null);
