...
import com.tunaPasta06.widget.SlidePageView;
import com.tunaPasta06.widget.SlidePageView.OnPageViewChangedListener;

public class NavigationBarRelevanceTest extends Activity {
    private String[] title = {"关注", "热门", "分类", "喜欢"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navigationbarrelevancetest);
        /* 获取组件 */
        final RollNavigationBar rnb = findViewById(R.id.uiademo_ui_RollNavigationBar);
        final SlidePageView spv = findViewById(R.id.uiademo_ui_SlidePageView);
