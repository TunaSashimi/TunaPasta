...
import com.tunaPasta06.tool.Rotate3DEffect;
import com.tunaPasta06.widget.Rotate3DEffectAnimations;
public class Rotate3DEffectTest extends Activity implements OnTouchListener  {
	private ViewGroup layoutmain;
	private ViewGroup layoutnext;
	private ViewGroup layoutlast;
	
	private Rotate3DEffect rotate3d;
	private Rotate3DEffect rotate3d2;
	private Rotate3DEffect rotate3d3;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rotate3deffecttest);
        ...
        Rotate3DEffectAnimations.initOffset(this);
       

		// 加号的动画
		composerButtonsShowHideButton.startAnimation(Rotate3DEffectAnimations.getRotateAnimation(0, 360, 200));
		...
		composerButtonsShowHideButton.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if (!areButtonsShowing) {
					// 图标的动画
					Rotate3DEffectAnimations.startAnimationsIn(composerButtonsWrapper, 300);
					// 加号的动画
					composerButtonsShowHideButtonIcon.startAnimation(Rotate3DEffectAnimations.getRotateAnimation(0, -225, 300));
				} else {
					// 图标的动画
					Rotate3DEffectAnimations.startAnimationsOut(composerButtonsWrapper, 300);
					// 加号的动画
					composerButtonsShowHideButtonIcon.startAnimation(Rotate3DEffectAnimations.getRotateAnimation(-225, 0, 300));
				}
		...
		for (int i = 0; i < composerButtonsWrapper.getChildCount(); i++) {
			...
			smallIcon.setOnClickListener(new View.OnClickListener() {
				public void onClick(View arg0) {
					...
					if(areButtonsShowing){
						composerButtonsShowHideButtonIcon.startAnimation(Rotate3DEffectAnimations.getRotateAnimation(-225, 0, 300));
						smallIcon.startAnimation(Rotate3DEffectAnimations.getMaxAnimation(400));
						for (int j = 0; j < composerButtonsWrapper.getChildCount(); j++) {
							if (j != position) {
								...
								smallIcon.startAnimation(Rotate3DEffectAnimations.getMiniAnimation(300));
	...
	public boolean onTouch(View arg0, MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			Log.i("dbtest","velocityTraker :"+mVelocityTracker.getXVelocity());
		...
		case MotionEvent.ACTION_UP:
			...
			Log.i("dbtest","velocityTraker2:"+mVelocityTracker.getXVelocity());
	...
	private void endRotateByVelocity(){
		if(degree > 0){
			rotate3d = new Rotate3DEffect(degree , 90 , 0, mCenterX, mCenterY);
			rotate3d3 = new Rotate3DEffect( - 90 + degree,0,0, mCenterX, mCenterY);
			...
			rotate3d = new Rotate3DEffect(degree , -90 , 0, mCenterX, mCenterY);
			rotate3d2 = new Rotate3DEffect( 90 + degree,0,0, mCenterX, mCenterY);
			rotate3d.setDuration(300);
	...
	private void endRotate() {
		if(degree > 45){
			...
			rotate3d = new Rotate3DEffect( degree , 0 , 0, mCenterX, mCenterY);
			rotate3d2 = new Rotate3DEffect(  90 + degree,90,0, mCenterX, mCenterY);
			rotate3d3 = new Rotate3DEffect(  - 90 + degree,- 90,0, mCenterX, mCenterY);
	...
	private void doRotate(int dx) {
		...
		rotate3d = new Rotate3DEffect(xd , degree , 0, mCenterX, mCenterY);
		rotate3d2 = new Rotate3DEffect( 90 + xd,  90+degree,0, mCenterX, mCenterY);
		rotate3d3 = new Rotate3DEffect(-90+xd, -90+degree,0, mCenterX, mCenterY);	
		if(currentTab == 0){
			layoutmain.startAnimation(rotate3d);
			layoutnext.startAnimation(rotate3d2);
			layoutlast.startAnimation(rotate3d3);
