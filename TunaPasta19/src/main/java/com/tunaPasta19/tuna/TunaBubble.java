...
public class TunaBubble extends TunaView {
    ...
    public TunaBubble(Context context) {
        this(context, null);
    }

    public TunaBubble(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TunaBubble(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        tunaTag = TunaBubble.class.getSimpleName();

        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.TunaBubble);

        tunaBubbleBackground = typedArray.getColor(R.styleable.TunaBubble_tunaBubbleBackground, Color.TRANSPARENT);
        tunaBubbleRadius = typedArray.getDimension(R.styleable.TunaBubble_tunaBubbleRadius, 0);

        tunaBubbleEdgeWidth = typedArray.getDimension(R.styleable.TunaBubble_tunaBubbleEdgeWidth, 0);
        tunaBubbleEdgeHeight = typedArray.getDimension(R.styleable.TunaBubble_tunaBubbleEdgeHeight, 0);

        tunaBubbleTextValue = typedArray.getString(R.styleable.TunaBubble_tunaBubbleTextValue);
        tunaBubbleTextSize = typedArray.getDimension(R.styleable.TunaBubble_tunaBubbleTextSize, 0);
        tunaBubbleTextColorNormal = typedArray.getColor(R.styleable.TunaBubble_tunaBubbleTextColorNormal, Color.TRANSPARENT);
        tunaBubbleTextPadding = typedArray.getDimension(R.styleable.TunaBubble_tunaBubbleTextPadding, 0);

        int tunaBubbleTowardTypeIndex = typedArray.getInt(R.styleable.TunaBubble_tunaBubbleTowardType, 0);
        ...
        int tunaBubbleLocationTypeIndex = typedArray.getInt(R.styleable.TunaBubble_tunaBubbleLocationType, 0);
        ...
        tunaBubbleOffset = typedArray.getDimension(R.styleable.TunaBubble_tunaBubbleOffset, 0);
        tunaBubbleStrokeColor = typedArray.getColor(R.styleable.TunaBubble_tunaBubbleStrokeColor, tunaBubbleBackground);
        tunaBubbleStrokeWidth = typedArray.getDimension(R.styleable.TunaBubble_tunaBubbleStrokeWidth, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (tunaBubbleTowardType) {
            case LEFT:
                ...
                inPolygonVertexY1 = inPolygonVertexY0 + tunaBubbleEdgeWidth * 0.5f;
            ...
            case TOP:
                ...
                inPolygonVertexY1 = inPolygonVertexY0 + tunaBubbleEdgeHeight;
                inPolygonVertexX2 = inPolygonVertexX1;
                inPolygonVertexY2 = inPolygonVertexY1 + tunaBubbleRadius;
        ...
        tunaPath.lineTo(inPolygonVertexX1, inPolygonVertexY1);
