 ...
 * @Description
 */
public class TunaTrackball extends TunaView {
    ...
    public TunaTrackball(Context context) {
        this(context, null);
    }

    public TunaTrackball(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TunaTrackball(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        tunaTag = TunaTrackball.class.getSimpleName();
