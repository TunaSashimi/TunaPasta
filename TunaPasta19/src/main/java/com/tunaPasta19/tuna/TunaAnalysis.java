...
public class TunaAnalysis extends TunaView {
    ...
    public TunaAnalysis(Context context) {
        this(context, null);
    }

    public TunaAnalysis(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TunaAnalysis(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        tunaTag = TunaAnalysis.class.getSimpleName();
    }
