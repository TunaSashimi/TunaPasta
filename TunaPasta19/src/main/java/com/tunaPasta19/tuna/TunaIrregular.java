 ...
 * @Description
 */
public class TunaIrregular extends TunaView {
    ...
    public TunaIrregular(Context context) {
        this(context, null);
    }

    public TunaIrregular(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TunaIrregular(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        tunaTag = TunaIrregular.class.getSimpleName();

        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.TunaIrregular);

        int tunaIrregularBitmapSrcNormalId = typedArray.getResourceId(R.styleable.TunaIrregular_tunaIrregularBitmapSrcNormal, -1);
        ...
        int tunaIrregularBitmapSrcSelectId = typedArray.getResourceId(R.styleable.TunaIrregular_tunaIrregularBitmapSrcSelect, -1);
