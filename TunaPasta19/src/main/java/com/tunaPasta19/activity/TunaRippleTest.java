...
import com.tunaPasta19.tuna.TunaRipple;

public class TunaRippleTest extends Activity {

    private static final int PLAY_TUNARIPPLE_ANIMATION = 0;

    private Button buttonPlay, buttonChange;
    private TunaRipple tunaRipple01, tunaRipple02, tunaRipple03, tunaRipple04;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tunarippletest);

        tunaRipple01 = findViewById(R.id.tunaRipple01);
        tunaRipple02 = findViewById(R.id.tunaRipple02);
        tunaRipple03 = findViewById(R.id.tunaRipple03);
        tunaRipple04 = findViewById(R.id.tunaRipple04);
