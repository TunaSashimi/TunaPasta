...
public class DoubleSlidingLayoutSlidingMenu extends RelativeLayout {
	...
	public DoubleSlidingLayoutSlidingMenu(Context context) {
		super(context);
		init(context);
	}
	...
	public DoubleSlidingLayoutSlidingMenu(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public DoubleSlidingLayoutSlidingMenu(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setCenterView(View view) {
		...
		bgShadeContent.setBackgroundDrawable(getResources().getDrawable(R.drawable.doubleslidinglayouttest_shade_bg));
