...
public class Rotate3DEffectAnimation extends Animation {
	...
	public Rotate3DEffectAnimation(float fromDegree, float toDegree, float depthZ, float centerX, float centerY) {
