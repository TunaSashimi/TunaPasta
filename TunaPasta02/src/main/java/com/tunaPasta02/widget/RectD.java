...
public class RectD implements Parcelable {
	 ...
	 * performed to see if either rectangle is empty. Note: To just dbtest for
	 ...
	 * is empty. To just dbtest for intersection, use intersects()
	 *
	 ...
	 * To just dbtest for intersection, use intersects()
	 *
