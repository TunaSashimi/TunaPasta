...
//			toast.setGravity(Gravity.CENTER, 0, 0);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.setpasswordtest);
			...
			public void onClick(View v) {
				...
				case R.id.tvSave:
					if (StringUtil.isNotEmpty(password)) {
						...
						startActivity(new Intent(SetPasswordTest.this,
								GesturePasswordTest.class));
						finish();
					} else {
						lpwv.clearPassword();
