...
public class OpenGLGestureCubeRotationTest extends Activity implements OnGestureListener {
	// 定义旋转角度
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		GestureCubeRotationRenderer myRender = new GestureCubeRotationRenderer(this);
		// 为GLSurfaceView设置绘制器
	...
	public boolean onSingleTapUp(MotionEvent event) {
	 ...
	 class GestureCubeRotationRenderer implements Renderer {
		...
		public GestureCubeRotationRenderer(Context main) {
			this.context = main;
			...
			cubeTexturesBuffer = BufferUtil.fBuffer(cubeTextures);
		}
		...
		private void loadTexture(GL10 gl) {
			...
			try {
				...
				bitmap = BitmapFactory.decodeResource(context.getResources(),
						R.drawable.opengltexture3dtest_bitmap_sand);
