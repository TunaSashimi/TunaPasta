...
public class OpenGLTwoDirectionsDisplacementTest extends Activity {
	TwoDirectionsDisplacementRenderer render = new TwoDirectionsDisplacementRenderer();

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		TwoDirectionsDisplacementImage.load(this.getResources());
...
class TwoDirectionsDisplacementRenderer implements Renderer {
	...
	public void LoadGLTextures(GL10 gl) {
		...
		GLUtils.texImage2D(GL10.GL_TEXTURE_2D, 0, TwoDirectionsDisplacementImage.mBitmapLogo, 0);
		/* Linear Filtering */
		...
		gl.glBindTexture(GL10.GL_TEXTURE_2D, texture[1]);
		/* Generate The Texture */
		GLUtils.texImage2D(GL10.GL_TEXTURE_2D, 0, TwoDirectionsDisplacementImage.mBitmapMask1, 0);
		/* Linear Filtering */
		gl.glTexParameterx(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_MIN_FILTER,
				GL10.GL_LINEAR);
		gl.glTexParameterx(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_MAG_FILTER,
		...
		gl.glBindTexture(GL10.GL_TEXTURE_2D, texture[2]);
		/* Generate The Texture */
		GLUtils.texImage2D(GL10.GL_TEXTURE_2D, 0, TwoDirectionsDisplacementImage.mBitmapImage1, 0);
		/* Linear Filtering */
		gl.glTexParameterx(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_MIN_FILTER,
				GL10.GL_LINEAR);
		gl.glTexParameterx(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_MAG_FILTER,
		...
		gl.glBindTexture(GL10.GL_TEXTURE_2D, texture[3]);
		/* Generate The Texture */
		GLUtils.texImage2D(GL10.GL_TEXTURE_2D, 0, TwoDirectionsDisplacementImage.mBitmapMask2, 0);
		/* Linear Filtering */
		gl.glTexParameterx(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_MIN_FILTER,
				GL10.GL_LINEAR);
		gl.glTexParameterx(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_MAG_FILTER,
		...
		gl.glBindTexture(GL10.GL_TEXTURE_2D, texture[4]);
		/* Generate The Texture */
		GLUtils.texImage2D(GL10.GL_TEXTURE_2D, 0, TwoDirectionsDisplacementImage.mBitmapImage2, 0);
		/* Linear Filtering */
		gl.glTexParameterx(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_MIN_FILTER,
				GL10.GL_LINEAR);
		gl.glTexParameterx(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_MAG_FILTER,
...
class TwoDirectionsDisplacementImage {
	...
	public static void load(Resources resources) {
		mBitmapImage1 = BitmapFactory.decodeResource(resources,
				R.drawable.image1);
		mBitmapImage2 = BitmapFactory.decodeResource(resources,
				R.drawable.image2);
		mBitmapLogo = BitmapFactory.decodeResource(resources, R.drawable.threepyramidandcuberotation);
		mBitmapMask1 = BitmapFactory
				.decodeResource(resources, R.drawable.mask1);
		mBitmapMask2 = BitmapFactory
				.decodeResource(resources, R.drawable.mask2);
	}
}