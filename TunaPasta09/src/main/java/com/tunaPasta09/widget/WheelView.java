...
import com.tunaPasta09.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    // 要添加的边上按钮的尺寸
    private static int ITEMS_TEXT_SIZE;

    // 要显示多少行
    /**
     * Top and bottom items offset (to hide that)
     */
    private static final int ITEM_OFFSET = VALUE_TEXT_SIZE / 5;
    ...
    public WheelView(Context context, AttributeSet attrs, int defStyle) {
        ...
        ADDITIONAL_ITEM_HEIGHT = (int) context.getResources().getDimension(R.dimen.additional_item_height);
        VALUE_TEXT_SIZE = (int) context.getResources().getDimension(R.dimen.text_size);
        ITEMS_TEXT_SIZE = (int) context.getResources().getDimension(R.dimen.item_offset);
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(ITEMS_TEXT_SIZE);
        }
