...
import com.tunaPasta07.tools.NativeRequest;
...
public class TabNewsActivity extends Activity {
    ...
    private void initViews() {
        ...
        int width = NativeRequest.getScreenWidth(this) / 6;
        RelativeLayout.LayoutParams param = new RelativeLayout.LayoutParams(width, LayoutParams.WRAP_CONTENT);
