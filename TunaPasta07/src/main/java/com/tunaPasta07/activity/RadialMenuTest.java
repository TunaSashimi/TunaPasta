...
import com.tunaPasta07.widget.RadialMenuWidget;
import com.tunaPasta07.widget.RadialMenuWidget.RadialMenuEntry;

public class RadialMenuTest extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Generating Pie view
        //------------------------------------------------------------------------------------------
        setContentView(R.layout.radialmenutest);
...
/*		final LinearLayout ll = new LinearLayout(this);
        ...
        Button testButton = this.findViewById(R.id.button1);
        testButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Toast.makeText(RadialMenuTest.this, "Button Clicked!",
...
/*				try {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        if (state == MotionEvent.ACTION_DOWN) {
            ...
            Toast.makeText(RadialMenuTest.this, "Screen Touched!",
                Toast.LENGTH_SHORT).show();
