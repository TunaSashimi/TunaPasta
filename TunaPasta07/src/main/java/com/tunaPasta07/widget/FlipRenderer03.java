...
import com.tunaPasta07.entity.FlipCards03;
import com.tunaPasta07.tools.TextureUtils;

public class FlipRenderer03 implements GLSurfaceView.Renderer {

	private FlipViewGroup02 flipViewGroup;

	private FlipCards03 cards;
	
	private boolean created = false;

	public FlipRenderer03(FlipViewGroup02 flipViewGroup) {
		this.flipViewGroup = flipViewGroup;

		cards = new FlipCards03();
		
	}

	public FlipCards03 getCards() {
		return cards;
	}
	@Override
