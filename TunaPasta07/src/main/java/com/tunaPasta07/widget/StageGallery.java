...
public class StageGallery extends Gallery {
	...
	public StageGallery(Context context) {
		super(context);
		// 支持转换 ,执行getChildStaticTransformation方法
		this.setStaticTransformationsEnabled(true);
	}

	public StageGallery(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.setStaticTransformationsEnabled(true);
	}

	public StageGallery(Context context, AttributeSet attrs, int defStyle) {
