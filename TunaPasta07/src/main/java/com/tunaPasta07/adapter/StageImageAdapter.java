package com.tunaPasta07.adapter;
...
public class StageImageAdapter extends BaseAdapter {
	...
	public StageImageAdapter(Context c, Integer[] ImageIds) {
		mContext = c;
		mImageIds = ImageIds;
	...
	public boolean createReflectedImages() {
		...
		for (int imageId : mImageIds) {
			...
			imageView.setLayoutParams(new StageGallery.LayoutParams(150, 200));
