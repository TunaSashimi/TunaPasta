...
public class VerificationView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    public VerificationView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.vericationView);
        mEtNumber = typedArray.getInteger(R.styleable.vericationView_vcv_et_number, 4);
        int inputType = typedArray.getInt(R.styleable.vericationView_vcv_et_inputType, VCInputType.NUMBER.ordinal());
        mEtInputType = VCInputType.values()[inputType];
        mEtWidth = typedArray.getDimensionPixelSize(R.styleable.vericationView_vcv_et_width, 120);
        mEtTextColor = typedArray.getColor(R.styleable.vericationView_vcv_et_text_color, Color.BLACK);
        mEtTextSize = typedArray.getDimensionPixelSize(R.styleable.vericationView_vcv_et_text_size, 16);
        mEtTextBg = typedArray.getResourceId(R.styleable.vericationView_vcv_et_bg, R.drawable.et_login_code);
        mCursorDrawable = typedArray.getResourceId(R.styleable.vericationView_vcv_et_cursor, R.drawable.et_cursor);
        cursorVisible = typedArray.getBoolean(R.styleable.vericationView_vcv_et_cursor_visible, true);

        isBisect = typedArray.hasValue(R.styleable.vericationView_vcv_et_spacing);
        if (isBisect) {
            mEtSpacing = typedArray.getDimensionPixelSize(R.styleable.vericationView_vcv_et_spacing, 0);
        }
        initView();
        //释放资源
        typedArray.recycle();
