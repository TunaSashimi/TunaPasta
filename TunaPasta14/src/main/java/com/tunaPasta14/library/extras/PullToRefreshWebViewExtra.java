 ...
 *******************************************************************************/
package com.tunaPasta14.library.extras;

import java.util.concurrent.atomic.AtomicBoolean;

import com.tunaPasta14.library.PullToRefreshWebView;
 ...
 * @author Chris Banes
 */
public class PullToRefreshWebViewExtra extends PullToRefreshWebView {
	...
	public PullToRefreshWebViewExtra(Context context) {
		super(context);
	}

	public PullToRefreshWebViewExtra(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PullToRefreshWebViewExtra(Context context, Mode mode) {
		super(context, mode);
	}
