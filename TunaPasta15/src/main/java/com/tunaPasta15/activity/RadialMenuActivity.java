...
public class RadialMenuActivity extends FragmentActivity {
    ...
    private ArrayList<RadialMenuItem> mMenuItems = new ArrayList<RadialMenuItem>(
            0);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        menuContactItem = new RadialMenuItem(getResources().getString(
                R.string.contact), getResources().getString(R.string.contact));
        menuMainItem = new RadialMenuItem(getResources().getString(
                R.string.main_menu), getResources().getString(
                R.string.main_menu));
        menuAboutItem = new RadialMenuItem(getResources().getString(
                R.string.about), getResources().getString(R.string.about));
        // Add the menu Items
        ...
        menuContactItem.setOnRadialMenuClickListener(new OnRadailMenuClick() {
            ...
            public void onRadailMenuClickedListener(String id) {
                ...
                getSupportFragmentManager()
                        .beginTransaction()
                        .replace(mHolderLayout.getId(),
                                new RadialMenuContactFragment()).commit();
            }
        });
    ...
    protected void onResume() {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(mHolderLayout.getId(), new RadialMenuMainFragment())
                .commit();
    }
}
