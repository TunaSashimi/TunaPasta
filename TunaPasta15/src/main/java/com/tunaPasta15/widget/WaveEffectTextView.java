...
public class WaveEffectTextView extends TextView {

    public interface AnimationSetupCallback {
        public void onSetupAnimation(WaveEffectTextView titanicTextView);
    }
    ...
    public WaveEffectTextView(Context context) {
        super(context);
        init();
    }

    public WaveEffectTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WaveEffectTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (!setUp) {
            ...
            if (animationSetupCallback != null) {
                animationSetupCallback.onSetupAnimation(WaveEffectTextView.this);
            }
        }
    }
