...
public class WaveEffect {
    ...
    public void start(final WaveEffectTextView textView) {
        ...
        if (!textView.isSetUp()) {
            textView.setAnimationSetupCallback(new WaveEffectTextView.AnimationSetupCallback() {
                @Override
                public void onSetupAnimation(final WaveEffectTextView target) {
                    animate.run();
                }
            });
        } else {
