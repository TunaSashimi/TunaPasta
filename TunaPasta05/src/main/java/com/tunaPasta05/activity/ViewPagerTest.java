...
public class ViewPagerTest extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewList.add(getLayoutInflater().inflate(R.layout.layout_0, null));
        viewList.add(getLayoutInflater().inflate(R.layout.layout_1, null));
        viewList.add(getLayoutInflater().inflate(R.layout.layout_2, null));
        viewList.add(getLayoutInflater().inflate(R.layout.layout_3, null));
        viewList.add(getLayoutInflater().inflate(R.layout.layout_4, null));
        viewList.add(getLayoutInflater().inflate(R.layout.layout_5, null));
        viewList.add(getLayoutInflater().inflate(R.layout.layout_0, null));
