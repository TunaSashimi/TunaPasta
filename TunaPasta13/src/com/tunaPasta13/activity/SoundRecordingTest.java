...
public class SoundRecordingTest extends ListActivity {
    /* 按钮 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.soundrecordingtest);
        /* 取得按钮 */
        ...
        if (Environment.getExternalStorageState().equals(
            ...
            Toast.makeText(SoundRecordingTest.this, "没有SD卡", Toast.LENGTH_LONG).show();
        }
        /* 开始按钮事件监听 */
            ...
            public void onClick(View arg0) {
                if (mRecAudioFile != null) {
                    ...
                    ArrayAdapter<String> musicList = new ArrayAdapter(
                            SoundRecordingTest.this, R.layout.soundrecordingtestitem, mMusicList);
