 ...
 */
public class NemesisReflectingImageAdapter extends TunaAbstractImageAdapter {

    /** The linked adapter. */
    private final TunaAbstractImageAdapter linkedAdapter;
    /**
     ...
     */
    public NemesisReflectingImageAdapter(final TunaAbstractImageAdapter linkedAdapter) {
        super();
