...
public class IDKeyboard {
    ...
    private IDKeyboardView mKeyboardView;
    private Keyboard mKeyboard;

    public IDKeyboard(Context context, IDKeyboardView keyboardView, EditText editText) {
        this.mEdittext = editText;
        mKeyboard = new Keyboard(context, R.xml.keyboardviewitem);//从xml中加载自定义的键盘
