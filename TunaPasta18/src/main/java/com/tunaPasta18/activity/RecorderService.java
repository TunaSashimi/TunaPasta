...
public class RecorderService extends Service implements
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Bundle bundle = null;//add by way
        if (intent != null) //add by way
            bundle = intent.getExtras();// ��ָ��
    ...
    private void showRecordingNotification() {
        ...
        Notification notification = new Notification.Builder(this)
                ...
                .setTicker(getString(R.string.notification_recording))
    ...
    private void showLowStorageNotification(int minutes) {
        ...
        mLowStorageNotification = new Notification.Builder(this)
                ...
                .setTicker(getString(R.string.notification_warning))
                .setContentTitle(getString(R.string.notification_warning))
    ...
    private void showStoppedNotification() {
        ...
        Notification notification = new Notification.Builder(this)
                .setSmallIcon(R.drawable.stat_sys_call_record)
                .setTicker(getString(R.string.notification_stopped))
                .setContentTitle(getString(R.string.notification_stopped))
